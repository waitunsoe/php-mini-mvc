  ...
  <div class="row justify-content-center">
    <div class="col-12 col-md-6 col-lg-4">
      <div class="rounded py-3 px-5 shadow">
        ...
        <form action="<?php echo route("list-update"); ?>" method="post">
          ...
          <div class="row justify-content-center align-items-center">
            ...
            <div class="col-12">
              <div class="form-floating mb-3">
                <input type="number" name="qty" value="<?php echo $list["qty"] ?>" id="qty" placeholder="Enter quantity" class="form-control form-control-sm" min="1" required>
